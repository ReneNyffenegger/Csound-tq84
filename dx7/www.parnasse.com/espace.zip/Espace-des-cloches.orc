        ...
        ksmps   =       1
        nchnls  =       2
        gasig2 init 0   ; global variable for phase-shifter
        ga1 init 0

; Russell Pinkston's DX7 Algorithm 16 Instrument
...
output:
 	...
 	k6gate	tablei	k6phs,idevfn
        ...
        ; orig with reverb ga1 = ga1 + .47 * a1sig*ipkamp
        ; orig with reverb outs     ga1,ga1 
...
;  Below is all Sean Costello's Phase shifters and FDN Reverb Orcs

instr 98    ; Ensemble section. Takes static sawtooth waves,
...
ktimea  oscili  4, 0.33, 18
ktimeb  oscili  4, 0.33, 18, .333
ktimec  oscili  4, 0.33, 18, .667
...
ktimed  oscili  1, 5.5, 18
ktimee  oscili  1, 5.5, 18, .333
ktimef  oscili  1, 5.5, 18, .667
