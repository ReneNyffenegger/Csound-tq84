...
;    w w ww w w ww w ww w w ww w ww
;  
;  G  maj7
;  Gm    7
;  Cm    7      / G
...
;  
;     s s  s s S  s s  s s s  s s
;    w w ww w w ww W wW w W ww w ww   Bb maj7
;  
;     s S  s s S  s s  s s s  s s
;    w w ww W w ww W ww w w ww w ww   Eb maj7
;  
;     s S  s s s  s s  s s s  s s
;    w w ww W W wW w ww w w ww w ww   ?
;  
...
instr 1 ;  breath
  ...
  krnd_frq  linen    ifreq2, 0.05*ilen, ilen, ilen*.3
  anoise    randi    krnd_amp, krnd_frq
  aosc      oscil    anoise, ifreq, 100
...
instr 2;   bass line (bassea_15)
        ...
        ifeedfn =       11
        ifeed   table   5,ifeedfn             ;0 <= p25 <= 7 (feedbk)
...
output:
 	...
 	k6gate	tablei	k6phs,idevfn
        ...
        a1sig   =       a1sig*k1gate
                outs     a1sig * ipkamp,a1sig *ipkamp
endin
...
instr 3
        ...
        iampl   =       p5
        iveloc  =       p6                      ;0 <= p5 <= 127
        iop1fn  =       20;p10                     ;param tables for ops
        iop2fn  =       21;p11
        iop3fn  =       22;p12
        iop4fn  =       23;p13
        iop5fn  =       24;p14
        iop6fn  =       25;p15
        iampfn  =       2;p16                     ;amp/level map function
        ipkamp  =       4000;p17                     ;scale for converter
        irsfn   =       3;p18                     ;rate scaling function
        idevfn  =       8;p19                     ;level/pkdev map func
        irisefn =       4;p20                     ;eg rise rate fn
        idecfn  =       6;p21                     ;eg decay rate fn
        ivsfn   =       10;p22                     ;vel sensitivity fn
        ivelfn  =       9;p23                     ;vel/amp fac map fn
        iveloc  table   iveloc,ivelfn           ;map this note's veloc
        ifeedfn =       11;p24
...
output:                  
 	...
 	k6gate	tablei	k6phs,idevfn
        ...
        a1sig   =       a1sig*k1gate
                outs     a1sig*ipkamp*iampl,a1sig*ipkamp*iampl
                endin
...
instr 4
        ...
        iampl   =       p5
        iveloc  =       p6                      ;0 <= p5 <= 127
        iop1fn  =       30                     ;param tables for ops
        iop2fn  =       31
        iop3fn  =       32
        iop4fn  =       33
        iop5fn  =       34
...
output:
 	...
 	k6gate	tablei	k6phs,idevfn
        ...
        a5phs   phasor  i5hz
        a5sig   tablei  a5phs+(.01*a6sig),1,1,0,1
        a5sig   =       a5sig*k5gate	
        ...
        a2phs   phasor  i2hz
        a2sig   tablei  a2phs+a6sig,1,1,0,1
        a2sig   =       a2sig*k2gate

        a1phs   phasor  i1hz
        a1sig   tablei  a1phs+a5sig,1,1,0,1
        a1sig   =       a1sig*k1gate
                outs     (a1sig + a2sig + a3sig + a4sig + a5sig)  * ipkamp * iampl, (a1sig + a2sig + a3sig + a4sig + a5sig)  * ipkamp * iampl
endin
