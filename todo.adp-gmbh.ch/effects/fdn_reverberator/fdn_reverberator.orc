...
; Or adjust to taste.
  ...
  igain = 0.9     ; gain of reverb. Adjust empirically
  ...
  itone = 5000    ; Cutoff frequency of lowpass filters
...
; number of delay lines.
  ...
  aoutl = afilt1 + afilt3 + afilt5 + afilt7
  aoutr = afilt2 + afilt4 + afilt6 + afilt8
